...
struct DetailView: View {
    ...
    //        Wee need refactor here i have a problem wıth lifecycle of the app i couldnt be succsesfully on detailCard while i am trying to open DetailCard i couldnt get the data at onAppear.
